...
query_mapping = {
     'SELECT_ERP_SHIPMENT_1_HEADER.sql': {
        'insert_query_file': 'INSERT_ERP_SHIPMENT_1_HEADER.sql',
        'table_name': 'ERP_Shipment_1_Header'
    },
     'SELECT_ERP_OCEAN_CONTAINERS.sql': {
        'insert_query_file': 'INSERT_ERP_OCEAN_CONTAINERS.sql',
        'table_name': 'ERP_Ocean_Containers'
    }
}
